...
document.addEventListener('DOMContentLoaded', function() {
  var cols = 8;
  var s = 256;
  var rows = Math.round((window.screen.height / 256)); //Calculate the rows by dividing the screen height by the spacing between the rows
  var pizzas = rows * cols; // Total number of pizzas are calculated as the result of rows (see above) and columns
